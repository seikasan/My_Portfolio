...
const artParagraphs = [
  'モデリングでは、お菓子の世界観に合うように、わたあめ、クッキー、ぺろぺろキャンディー、ドーナツ、ホイップクリーム、敵のガムなどを制作しました。',
  'わたあめシェーダーでは、ふわふわした柔らかさが出るように調整しました。敵のガムにはアニメーションも付け、ゲーム内で動いたときにもお菓子らしい印象が出るようにしています。水面シェーダーも作成し、激辛ソースのようなステージギミックにも使える表現として組み込んでいます。',
  ...
  return (
    <article className={styles.content}>
      ...
      <section className={styles.section}>
        ...
        <YouTubeEmbed
          videoUrl="https://youtu.be/ZDpMHxnWo9E"
          title="ちょこ旅 3Dモデルとアニメーション"
          entryLabel="3DモデルとアニメーションをYouTubeで開く"
          caption="制作した3Dモデル・アニメーション"
        />
        <InlineImageGrid />
      </section>
